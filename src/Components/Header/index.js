  ...
  return (
    <div>
            ...
            <div class="offcanvas-body">
              <form class="d-flex flex-column" role="search">
                <span class="nav-login-btn">
                  <a href="./src/signin.html">log In</a>
                </span>
                <span class="nav-sell-btn">
                  <a href="./src/AddsPosts/post.html">Start Selling</a>
                </span>
                <span class="nav-sell-btn">
                  <a href="./src/useradds/useradd.html">My Adds</a>
                </span>
                <span class="nav-sell-btn">
      ...
      <div class="header-top">
        ...
        <div class="header-a">
          <a href="">
            <i class="fa-solid fa-car"></i> MOTORS
          </a>
        </div>
        <div class="header-a2">
          <a href="">
            <i class="fa-regular fa-building"></i> PROPERTY
          </a>
        </div>
      </div>
      <div class="header">
        ...
        <div class="parent-inp">
          <input
            type="text"
            placeholder="Find car,Mobile Phones & more"
            name="abc"
            id="input"
          />
          <div class="icon-2">
        ...
        <div class="btn-div">
          <button id="logIn-button" onClick={() => navigate("/signin")}>
            Log-In
          </button>
          <div class="dropdown" id="userName">
            ...
            <ul class="dropdown-menu">
              <li>
                <a class="dropdown-item" href="./src/useradds/useradd.html">
                  My Adds
                </a>
              </li>
              <li>
          ...
          <button class="sell" onClick={() => navigate("/addpost")}>
            {" "}
            <b> +Sell </b>
          </button>
        </div>
